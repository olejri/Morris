...
\begin{figure}[H]
	...
	\subfigure[Achievements]{\includegraphics[width=0.3\textwidth]{Images/achievements.png}}
	\subfigure[Help explaining the games rules]{\includegraphics[width=0.3\textwidth]{Images/help.png}}
	}	
\end{figure}
